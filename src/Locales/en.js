export default{
  "translation":{
    ...
    //settings user
      ...
      //Language
      "title-lang": "Language",
      "p1" : 'Select the language you will use in Flylinkers',
      "p2" : 'You can change it again at any time.',
      "select-lg-1" : 'Select a language',
      "select-lg-2" : 'English',
      "select-lg-3" : 'Spanish',
    ...
    //Modals
      ...
      "modal-xp-year": "Year",
      "modal-delete-xp-title": "Remove experience",
      "modal-delete-xp-content": "Are you sure you want to delete your experience?",
      "modal-delete-xp-btn-close": "Close",
      "modal-delete-xp-btn-del": "Delete",
