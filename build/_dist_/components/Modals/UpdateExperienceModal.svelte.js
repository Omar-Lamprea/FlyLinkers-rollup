import './UpdateExperienceModal.svelte.css';
...
// (237:22) {#if joinStartMonth === month.value}
...
// (246:22) {#if parseInt(dataStartYear) === year}
...
function create_else_block(ctx) {
	...
	return {
		c() {
			...
			attr(select0, "class", "me-md-1 mb-3 svelte-evpc5g");
			option.__value = "0";
			option.value = option.__value;
			...
			attr(select1, "class", "mb-3 svelte-evpc5g");
		},
		m(target, anchor) {
...
// (279:24) {#if joinEndMonth === month.value}
...
// (288:24) {#if parseInt(dataEndYear) === year}
...
// (261:25) {#if joinEndMonth === month.value}
...
// (270:25) {#if parseInt(dataEndYear) === year}
...
// (316:16) {#if experience.employment_type === employment}
...
// (315:14) {#each employmentTypeList as employment}
	...
	return {
		c() {
          ...
          <p class="my-3">* Indicates required</p>`;
			...
			attr(input0, "class", "svelte-evpc5g");
			...
			attr(div4, "class", "start me-md-1 svelte-evpc5g");
			...
			attr(div6, "class", "end svelte-evpc5g");
			attr(div7, "class", "dates svelte-evpc5g");
			...
			attr(input1, "class", "svelte-evpc5g");
			...
			attr(input2, "class", "svelte-evpc5g");
			...
			attr(input3, "class", "svelte-evpc5g");
			...
			attr(select2, "class", "svelte-evpc5g");
			...
			attr(textarea, "class", "svelte-evpc5g");
			attr(form, "action", "");
			attr(form, "class", "svelte-evpc5g");
			...
			attr(button2, "class", "btn btn-outline-primary btn-flylinkers btn-save-experience svelte-evpc5g");
			attr(div11, "class", "modal-footer");
			attr(div12, "class", "modal-content svelte-evpc5g");
