...
// (197:8) {#if email === localStorage.getItem('user')}
function create_if_block(ctx) {
	...
	return {
		c() {
			a = element("a");
			a.innerHTML = `<p type="button" class="mb-3" style="color:rgba(38, 38, 38, 07)"><i class="fas fa-pen svelte-lxt76k"></i> Edit profile</p>`;
			t1 = space();
